                    ...
                    <form method="post" enctype="multipart/form-data">
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-6 col-md-6 col-sm-12">
                                ...
                                <label>Title:</label> {{$specification->title}}<br>
                                <label>Specification:</label> {{$specification->specification}}<br>
                                <label class="error">Are you sure you want to delete this specification?</label>
                            </div>
                        </div>
