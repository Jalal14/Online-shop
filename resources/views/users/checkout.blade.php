                ...
                <div class="panel-body">
                    <div class="row">
                        <div class="col-md-12 col-sm-12" id="select_address">
                            <div class="radio">
                                <label><input type="radio" name="registered-customer-address" id="existing_address_radio" checked>Use my existing address</label>
                            </div>
                            <div class="radio">
                                <label><input type="radio" name="registered-customer-address" id="another_address_radio">Another address</label>
                            </div>
                        </div>
            ...
            <div id="guest-customer-section" class="panel panel-default">
                ...
                <div class="panel-body">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" name="transaction-no" placeholder="Transaction no" class="form-control">
                    </div>
                    <input type="submit" name="continue" value="Confirm" class="btn btn-primary">
                </div>
            </div>
        </div>
    </div>
